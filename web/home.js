...
(function () {
  ...
  const TOOLS = [
    ...
    { id: 'verification', group: 'Models & history', title: 'Check a model’s recent errors', detail: 'Match archived model runs to ERA5 reanalysis by lead time. A measurement against reanalysis, not a skill score.', output: 'Error table by lead time', action: () => { window.location.hash = '#/verification'; } },
