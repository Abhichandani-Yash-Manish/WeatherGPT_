...
i=0; while [ $i -lt 30 ]; do n=$(agent-browser eval '(function(){ var t=document.querySelectorAll(".turn"); return String(t.length); })()' 2>/dev/null | tail -1); case "$n" in '"2"') break;; esac; sleep 3; i=$((i+1)); done
echo "waited=$((i*3))s turns=$n"
...
agent-browser eval '(function(){ var e=(document.querySelector("#error")||{}).textContent||""; return e?("page error: "+e):"no page error"; })()' 2>&1 | tail -1
