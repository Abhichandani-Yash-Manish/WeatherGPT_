...
KINDS=['forecast','history','travel','agriculture','warning','observation','research','explanation','aviation','marine','river','document','ensemble','air_quality','verification','imd_forecast','nowcast','chat']
