...
> Current combined integration is recorded in [docs/72](72-integrated-status-and-ps-review.md) and delivery follow-up [docs/73](73-dissemination-integration-review.md). Runtime absence statements and counts below describe the original audit or branch checkpoint.
