# 140 — WeatherGPT, the full account

> This was the README until 22 September 2026. It is the complete record: every requirement read line by
> line, every subsystem explained, every limit named, and the account of how the chat, the palette and the
> surfaces were reworked. Nothing here is out of date — it was moved because a front page and a reference
> manual are different documents, and a judge with ten minutes was being handed the second one.
>
> The front page is [README.md](../README.md). This is what it links to.
...
serve it, and check it:
    ...
    cd frontend && npm test                        # 81 component suites, 538 checks, run under Vitest
