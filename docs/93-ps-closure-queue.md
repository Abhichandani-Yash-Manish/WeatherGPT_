...
| React suite | 61 suites, 340 component checks, `tsc --noEmit` clean (55 and 296 before docs/96; docs/97 added the dashboard suite; the aurora-glass overhaul of docs/98 added the kit suite; the reported-defect repairs of docs/99 added the matrix geometry checks) | `frontend/`, run under Vitest |
