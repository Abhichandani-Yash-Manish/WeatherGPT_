...
| Python suite | 1309 tests collected and passing, which is the count the README records | `python3 -m pytest tests/ -q` |
| React suite | 55 suites, 296 component checks, `tsc --noEmit` clean | `frontend/`, run under Vitest |
...
| Corpus, as the product read it | the Published documents page read 588 documents, 7,372 passages and 570 regions in the 17 September capture | `docs/images/06-documents.png` |
