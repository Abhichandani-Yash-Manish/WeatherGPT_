...
CAPABILITIES=[
 ...
 {'tool':'official_warning','kind':'warning','operations':['lookup'],'sources':['S01','S06','S15'],'parameters':['official_warning'],'purpose':'Current applicability not verified; source metadata/reference only','available':False},
 {'tool':'crop_advisory','kind':'agriculture','operations':['lookup'],'sources':['S57'],'parameters':[],'purpose':'Reviewed current crop/stage/area bulletin retrieval not connected','available':False},
