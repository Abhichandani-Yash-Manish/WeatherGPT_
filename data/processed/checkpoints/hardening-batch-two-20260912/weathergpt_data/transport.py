...
class Store:
    ...
    def _fetch_locked(self,source_id,url,key,ttl,max_bytes,refresh,validator,product_validator):
        ...
        try:
        ...
        except (urllib.error.URLError,TimeoutError,OSError,ValueError,TypeError,KeyError,OverflowError) as exc:
            ...
            if previous_data is not None:
                ...
                except (ValueError,TypeError,KeyError,OverflowError) as invalid:raise SourceError('No cached data satisfies the current request: '+str(invalid)) from invalid
