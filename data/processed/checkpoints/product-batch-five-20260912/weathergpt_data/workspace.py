...
def make_server(workspace, port=8765):
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if self.path not in {'/api/answer','/api/refresh'}:return self.respond(404,{'error':'Not found'})
            try:
                ...
                result=workspace.refresh(body) if self.path=='/api/refresh' else workspace.answer(body)
