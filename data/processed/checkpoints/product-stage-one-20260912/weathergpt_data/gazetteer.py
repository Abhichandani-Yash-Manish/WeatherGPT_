...
class Gazetteer:
    ...
    def search(self,name,state='',district=''):
        ...
        return [{**r,'match_type':'approximate_name_requires_confirmation' if approximate else 'source_name_or_alias','selection_id':'geonames:'+r['id'],'label':r['name']+', '+r['admin2']+', '+r['admin1'],
