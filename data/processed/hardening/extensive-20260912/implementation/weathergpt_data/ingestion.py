...
from .adapters import FORECAST,MARINE,temporal_support
...
class IngestionDB:
    ...
    def complete(self, job, result):
        ...
        parameters=set(FORECAST if spec['product']=='forecast' else MARINE if spec['product']=='marine' else {'river_discharge'})
