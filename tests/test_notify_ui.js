...
const PAYLOADS = {
  ...
  '/api/watches': { schema_version: 'watch-inbox-v1', delivery: 'local_inbox_only_no_push', note: '',
                    checked_products: [], watches: [WATCH] },
  '/api/watches/check': { schema_version: 'watch-check-v1', delivery: 'local_inbox_only_no_push', results: [], dispatched: [], escalated: [] },
  ...
  '/api/outbox': { schema_version: 'outbox-v1', delivery: 'local_inbox_only_no_push', note: '', notifications: ROWS },
  '/api/outbox/o1/ack': { schema_version: 'outbox-ack-v1', id: 'o1', state: 'acked', response: 'safe', feedback_id: 'f1' },
  '/api/push/state': { schema_version: 'push-state-v1', delivery: 'local_inbox_only_no_push', note: '', purged_expired: 0, subscriptions: { active: 0 } },
